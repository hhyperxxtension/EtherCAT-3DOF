...
# Write velocity factor 1.0
slave.sdo_write(0x6081, 0, struct.pack('f', 1.0))
print('Set velocity factor to 1.0')
# Set mode profile velocity and enable drive
...
# Test raw = RPM values from 10 to 1000
for rpm in [10,20,50,100,200,500,1000,2000,3000,4000]:
    ...
    print(f'RPM {rpm}: actual_raw={actual}, torque={torque}')
# Stop
